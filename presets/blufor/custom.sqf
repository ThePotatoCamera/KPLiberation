...
FOB_truck_typename = "ffaa_et_m250_estacion_nasams_blin";             	// This is the FOB as a vehicle.
Arsenal_typename = "B_supplyCrate_F";                                   // This is the virtual arsenal as portable supply crates.
Respawn_truck_typename = "ffaa_et_lince_ambulancia";    				// This is the mobile respawn (and medical) truck.
huron_typename = "RHS_CH_47F";                        					// This is Spartan 01, a multipurpose mobile respawn as a helicopter.
crewman_classname = "ffaa_bripac_soldado_ds";                    		// This defines the crew for vehicles.
pilot_classname = "ffaa_pilot_her_des";                          		// This defines the pilot for helicopters.
...
KP_liberation_boat_classname = "ffaa_ar_supercat";                 		// These are the boats which spawn at the stern of the Freedom.
...
light_vehicles = [
	...
	["ffaa_ar_lcm",200,0,50],											// LCM-1E
	["ffaa_et_vamtac_m2",100,50,50],									// Vamtac M2
	["ffaa_et_vamtac_lag40",100,75,50],									// Vamtac LAG40
	["ffaa_et_vamtac_tow",100,100,50],									// Vamtac TOW
	["ffaa_et_rg31_samson",150,50,75]									// RG31 Nyala
];
...
heavy_vehicles = [
	...
	["ffaa_et_pizarro_mauser",300,250,175],								// Pizarro
	["ffaa_et_leopardo",500,900,300]									// Leopardo
];
...
air_vehicles = [
	...
	["FIR_F14A_BLANK",1000,1000,450],									// F-14A Tomcat
	...
	["ffaa_famet_tigre",500,550,300],									// Tigre
	["ffaa_ar_harrier",1000,750,1000],									// Harrier
	["ffaa_famet_cougar",300,0,225],									// Cougar (Transporte)
	["ffaa_famet_cougar_armed",300,250,225]								// Cougar (Armado)
];
...
static_vehicles = [
    ...
    ["ffaa_tow_tripode",50,100,0],                                      // TOW (AT)
...
support_vehicles = [
    ...
    ["ffaa_et_pegaso_repara_municion",325,200,75],                      // Pegaso Repara-municion
    ["ffaa_et_pegaso_combustible",125,0,275],                           // Pegaso combustible
    ["ffaa_et_pegaso_municion",125,200,75],                         	// Pegaso munición
...
elite_vehicles = [
	...
	"ffaa_et_pizarro_mauser",											// Pizarro
	"ffaa_et_leopardo",													// Leopardo
	"ffaa_famet_tigre",													// Tigre
	"FIR_F14A_BLANK"													// F-14 Tomcat
];
